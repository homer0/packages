...
/**
 * Utility type to create a "config instance type" based on a dictionary of settings. It
 * will assume that the settings are the return type of the config slices.
 */
 ...
 * `createGetConfig`, or doesn't use TypeScript.
 *
 * @ignore
 */
