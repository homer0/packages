...
/**
 * The actual dependency injection container. The keys will be the original functions, and the
 * values may be the same, or the overrides.
 *
 * @type {Map<Function, Function>}
 */
const container = new Map();
/**
 * This secret exists so when {@link registerModule} gets called with a raw `module.exports`, it
 * can safely skip a provider, as providers created with {@link provider} have this secret as a
 * property.
 *
 * @type {symbol}
 */
...
/**
 * Registers a list or a dictionary of functions for a module. The idea of this function is that it
 * can be easily use to register a `module.exports`. Check the example.
 *
 * @example
 ...
 *
 * @param {string}                              id  The ID of the module; it will be added as the
 *                                                  `moduleId` property of the functions.
 * @param {Function[]|Object.<string,Function>} fns The list or dictionary of functions.
 */
...
/**
 * Creates a "module provider": a function that when called, it will execute {@link registerModule}.
 * The idea of the providers is that they can be executed on runtime, or on a "registration step".
 *
 ...
 * @param {string[]} list           A list of files with a `provider` export that should be
 *                                  executed.
 */
